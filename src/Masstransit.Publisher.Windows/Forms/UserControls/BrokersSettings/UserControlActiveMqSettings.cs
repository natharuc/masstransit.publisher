...
{
    public partial class UserControlActiveMqSettings : UserControl, IUserControlBrokerSettings
    {
        public UserControlActiveMqSettings()
        {
            InitializeComponent();
        }
        ...
        public BrokerSettings GetSettings()
        {
            ...
            {
                Broker = Domain.Classes.Enumns.Broker.ActiveMq,
